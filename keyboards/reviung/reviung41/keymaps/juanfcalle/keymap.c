...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT(
     ...
     KC_BSPC, KC_A, CTL_R, ALT_S,              CMD_TE,               KC_D,                      KC_H,              CMD_N,   ALT_E,  CTL_I,    KC_O,  KC_ESC,
      KC_TAB, KC_Z, KC_X,   KC_C,                KC_V,               KC_B,                      KC_K,               KC_M, KC_COMM, KC_DOT, KC_SLSH,  KC_ENT,
                                  LT(HIGHER, KC_LEFT), LT(LOWER, KC_DOWN), SFT_SPC, LT(LOWER, KC_UP), LT(HIGHER, KC_RGHT)
  ),
  ...
  [_HIGHER] = LAYOUT(
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_VOLU,          KC_MNXT, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
    XXXXXXX,  KC_F12, KC_LCTL, KC_LALT, CMD_F10, UG_TOGG,          KC_MPLY,  CMD_F1, KC_RALT, KC_RCTL,  KC_F11, XXXXXXX,
    _______,   KC_F6,   KC_F7,   KC_F8,   KC_F9, KC_VOLD,          KC_MPRV,   KC_F2,   KC_F3,   KC_F4,   KC_F5, _______,
